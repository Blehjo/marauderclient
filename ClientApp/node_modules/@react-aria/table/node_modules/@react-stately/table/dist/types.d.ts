...
import { CollectionStateBase, Node, SelectionMode, Sortable, SortDescriptor } from "@react-types/shared";
...
export interface TableStateProps<T> extends CollectionStateBase<T, _TableCollection1<T>>, MultipleSelectionStateProps, Sortable {
    /** Whether the row selection checkboxes should be displayed. */
    showSelectionCheckboxes?: boolean;
