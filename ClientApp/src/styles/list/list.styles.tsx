...
import QuoteItem from '../item/item.styles';
import { TitleContainer, grid } from '../constants/constants.styles';
...
function InnerList(props) {
  ...
  const title = props.title ? <TitleContainer>{props.title}</TitleContainer> : null;
