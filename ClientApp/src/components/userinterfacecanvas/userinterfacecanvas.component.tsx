    ...
    render() {
        ...
        return (
            <UserInterfaceCanvasContainer>
                <Offcanvas style={{ background: 'rgba(0, 0, 0, .75)', width: '25%', borderRadius: '.5rem 0rem 0rem .5rem', borderTop: '1px solid white', borderLeft: '1px solid white', borderBottom: '1px solid white', color: 'white' }} scroll backdrop={false} placement="end" show={show} onHide={handleClick}>
                    <Offcanvas.Header >
